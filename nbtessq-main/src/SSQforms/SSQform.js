...
import Questionaire from "./FormComponents/Questionnaire";
...
class SSQform extends Component {
  constructor(props) {
    ...
    this.Table6Title =
      "All tools contained in the laboratory workshop or studio";
    this.Table7Title =
      "All the tools and equipment in the facilities listed in the above table";
    this.Table8Title = "Facilities Under Construction";
    this.Table9Title = "CROP FARMS";
    this.Table10Title = "Livestock Farms";
    this.Table11Title =
      "All equipment contained in each of the facilties listed in Livestock Farms";
    this.Table12Title = "Other Teaching Facilities";
    this.Table13Title =
      "All the equipment contained in each of the facilities in Other Teaching facilities above";
    this.Table14Title = "Office Accommodation";
    this.Table15Title = "Teaching Staff";
    this.Table16Title = "Service Staff";
    this.Table17Title =
      "List all full time Technologicians/Technicians available exclusively for the Programme";
    this.Table18Title =
      "All administrative staff in the department in order seniority";
    this.state = {
      submitted: false,
      pageNumber: 1,
      ProgrammeTitle: "",
  ...
  sendDataToServer = (pageNumber) => {
    switch (pageNumber) {
      case 1:
        fetch(
          `https://ssq2-2f329.firebaseio.com/Institutions/${this.props.databaseKey}.json`,
          {
            method: "POST",
            body: JSON.stringify({
              [this.Table1Title]: this.state.table1Data,
  ...
  onFileInputFieldChangedHandler = (number) => (e) => {
    switch (number) {
      case 1:
        this.setState({
          FileOfDepartmentalOrganizationalStructure: e.target.files,
        });
        break;
      case 2:
        this.setState({ LetterOfApprovalFromTheMinistry: e.target.files });
        break;
      case 3:
        this.setState({
          FileForTheTeachingDepartmentalCurriculum: e.target.files,
        });
        break;
      default:
        this.setState({
  ...
  onInputFieldChangedHandler = (number) => (e) => {
    switch (number) {
      case 1:
        this.setState({ ProgrammeTitle: e.target.value });
      ...
      case 2:
        ...
        break;
      case 3:
        this.setState({ DateEstablished: e.target.value });
        break;
      case 4:
        this.setState({ NameOfTheChiefExecutive: e.target.value });
        break;
      case 5:
        this.setState({ TitleOfTheChiefExecutive: e.target.value });
        break;
      case 6:
        this.setState({ NameOfTheHeadOfDepartment: e.target.value });
        break;
      case 7:
        this.setState({ TitleOfTheHeadOfDepartment: e.target.value });
        break;
      case 8:
        this.setState({
          FileOfDepartmentalOrganizationalStructure: e.target.files,
      ...
      case 10:
        ...
        break;
      case 11:
        this.setState({ BriefCurriculumForStudentsEnrollment: e.target.value });
        break;
      case 12:
        this.setState({ LibraryInformation: e.target.files });
        break;
      case 13:
        this.setState({ ProgrammeReadiness: e.target.value });
        break;
      case 14:
        this.setState({
          NameOfTheOfficerCompletingTheQuestionnaire: e.target.value,
        });
        break;
      case 15:
        this.setState({
          DesignationOfTheOfficerCompletingTheQuestionnaire: e.target.value,
        });
        break;
      case 16:
    ...
    var tableRow = tableHeaderList.map((data) => {
      ...
      if (data === "id") {
        ...
        return (
          <td key={data}>
            <input
              onChange={this.handleChange(rowData["id"] - 1, data, TableNumber)}
              TableNumber={TableNumber}
              row={rowData["id"] - 1}
              column={data}
              columnLength={tableHeaderList.length}
            />
          </td>
        );
      }
      ...
      switch (TableNumber) {
        case 1:
          if (type === "DEL") {
            ...
            return {
              table1Data: state.table1Data.concat(data),
        ...
        case 4:
          if (type === "DEL") {
            ...
            return {
              table4Data: state.table4Data.concat(data),
        ...
        case 5:
          if (type === "DEL") {
            ...
            return {
              table5Data: state.table5Data.concat(data),
        ...
        case 6:
          if (type === "DEL") {
            ...
            return {
              table6Data: state.table6Data.concat(data),
        ...
        case 7:
          if (type === "DEL") {
            ...
            return {
              table7Data: state.table7Data.concat(data),
        ...
        case 8:
          if (type === "DEL") {
            ...
            return {
              table8Data: state.table8Data.concat(data),
        ...
        case 9:
          if (type === "DEL") {
            ...
            return {
              table9Data: state.table9Data.concat(data),
        ...
        case 10:
          if (type === "DEL") {
            ...
            return {
              table10Data: state.table10Data.concat(data),
        ...
        case 11:
          if (type === "DEL") {
            ...
            return {
              table11Data: state.table11Data.concat(data),
        ...
        case 12:
          if (type === "DEL") {
            ...
            return {
              table12Data: state.table12Data.concat(data),
        ...
        case 13:
          if (type === "DEL") {
            ...
            return {
              table13Data: state.table13Data.concat(data),
        ...
        case 14:
          if (type === "DEL") {
            ...
            return {
              table14Data: state.table14Data.concat(data),
        ...
        case 15:
          if (type === "DEL") {
            ...
            return {
              table15Data: state.table15Data.concat(data),
        ...
        case 16:
          if (type === "DEL") {
            ...
            return {
              table16Data: state.table16Data.concat(data),
        ...
        case 17:
          if (type === "DEL") {
            ...
            return {
              table17Data: state.table17Data.concat(data),
        ...
        case 18:
          if (type === "DEL") {
            ...
            return {
              table18Data: state.table18Data.concat(data),
    ...
    return (
      <div>
        <Route
          path="/"
          render={() => (
            <Toolbar institutionName={this.props.institutionName} />
          )}
        />
        {redirect}
        <Switch>
          ...
          <Route
            ...
            render={() => (
              <SSQform2
                nextPage={this.moveToNextPage}
                table4Rows={this.state.table4Rows}
                table4Data={this.state.table4Data}
                addRow={this.addRow}
                table5Rows={this.state.table5Rows}
                table6Rows={this.state.table6Rows}
                table7Rows={this.state.table7Rows}
                table8Rows={this.state.table8Rows}
                deleteLastRow={this.deleteLastRow}
                initializeTable={this.initializeTable}
              />
            )}
          ...
          <Route
            ...
            render={() => (
              <SSQform3
                nextPage={this.moveToNextPage}
                table9Rows={this.state.table9Rows}
                table10Rows={this.state.table10Rows}
                table11Rows={this.state.table11Rows}
                table12Rows={this.state.table12Rows}
                table13Rows={this.state.table13Rows}
                table14Rows={this.state.table14Rows}
                addRow={this.addRow}
                deleteLastRow={this.deleteLastRow}
                initializeTable={this.initializeTable}
          ...
          <Route
            ...
            render={() => (
              <SSQform4
                nextPage={this.moveToNextPage}
                table15Rows={this.state.table15Rows}
                table16Rows={this.state.table16Rows}
                table17Rows={this.state.table17Rows}
                table18Rows={this.state.table18Rows}
                renderTableHeaderList={this.renderTableHeaderList}
                addRow={this.addRow}
                deleteLastRow={this.deleteLastRow}
                initializeTable={this.initializeTable}
          ...
          <Route
            path="/SSQform5"
            render={() => <SSQform5 nextPage={this.moveToNextPage} />}
          />
          <Route
            path="/SSQform6"
            render={() => <SSQform6 nextPage={this.moveToNextPage} />}
          />
          <Route
            path="/SSQform7"
            render={() => <SSQform7 nextPage={this.moveToNextPage} />}
          />
          <Route
            path="/SSQform8"
            render={() => <SSQform8 nextPage={this.moveToNextPage} />}
          />
        </Switch>
      </div>
    );
