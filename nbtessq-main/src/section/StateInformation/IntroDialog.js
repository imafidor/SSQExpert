...
closeDialog=()=>{
    ...
    render() {
        return (
           ...
           <motion.h5 initial ={{x:500,opacity:0}} animate={{x:0,opacity:1, transition:{delay:0.3,duration:0.3}}} exit={{x:-500,opacity:0,transition:{delay:0.3}}}> Please select which programme to mount</motion.h5>        
